 ...
 */
#ifndef BPL_PROTOCOL__CRC_HPP_
#define BPL_PROTOCOL__CRC_HPP_
...
private:
public:
  static unsigned crc8(unsigned crc, unsigned char const * data, size_t len);
};

}  // namespace bpl_protocol

#endif /* BPL_PROTOCOL__CRC_HPP_ */
